...
export const ENROLLMENT_CAUTION = Object.freeze({
  ...
  3. 경매 마감 시간 경매의 마감 시간은 자동으로 24시간으로 설정됩니다. 이 시간 동안 입찰자들은 자유롭게 입찰할 수 있으며, 경매 종료 시점에 최고 입찰가가 낙찰자로 결정됩니다.
  
  4. 경매 제한 시간 및 최고 입찰가 공개 최고 입찰가는 낙찰이 확정된 후 공개되므로, 판매자는 이 점을 유의하여 경매를 진행해야 합니다.`,
});
