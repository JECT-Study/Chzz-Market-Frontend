...
export const Confirm = ({ type, children, onCloseModal }: ConfirmProps) => {
  ...
  return (
    <div aria-label="확인 모달" onClick={(e) => e.stopPropagation()} className='min-w-[17rem] min-h-[13rem] w-[48%] max-w-[23rem] flex items-center gap-3 flex-col justify-between p-8 bg-white rounded-lg web:text-body1 text-body2'>
