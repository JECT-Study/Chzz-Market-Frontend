export const ROUTES = Object.freeze({
  ...
  PRE_AUCTION: {
    ...
    getEditRoute: (auctionId: number) =>
      `/auctions/pre-auction/edit/${auctionId}`
  },
  ...
  getBidderListRoute: (auctionId: number) =>
    `/auctions/${auctionId}/bidder-list`,
  ...
  PAYMENT: {
    ...
    ADDRESS: {
      ...
      getListRoute: (auctionId: string) =>
        `/auctions/${auctionId}/payment/address-list`,

      ADD: '/auctions/:auctionId/payment/address-add',
      getAddRoute: (auctionId: string) =>
        `/auctions/${auctionId}/payment/address-add`,

      EDIT: '/auctions/:auctionId/payment/address-edit',
      getEditRoute: (auctionId: string) =>
        `/auctions/${auctionId}/payment/address-edit`,

      EDIT_LIST: '/auctions/:auctionId/payment/address-edit-list',
      getEditListRoute: (auctionId: string) =>
        `/auctions/${auctionId}/payment/address-edit-list`
    },
