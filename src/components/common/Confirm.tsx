...
const Confirm = ({ type, children, onCloseModal }: ConfirmProps) => {
  ...
  return (
    <div onClick={(e) => e.stopPropagation()} className='min-w-[17rem] min-h-[13rem] w-[45%] max-w-[23rem] flex items-center flex-col justify-between p-8 bg-white rounded-lg sm:text-body1 text-body2'>
