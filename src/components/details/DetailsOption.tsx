...
const DetailsOption = ({ clickEdit, confirmDelete, isPending, onCloseModal }: DetailsOptionProps) => {
  const ref = useOutsideClick(onCloseModal)

  return (
    <div ref={ref} className='absolute flex flex-col bg-white rounded-lg w-[10rem] top-12 right-8 sm:text-body1 text-body2'>
