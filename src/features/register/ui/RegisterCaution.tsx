...
import { PRE_REGISTER_CAUTION, REGISTER_CAUTION } from '../config/caution';
  ...
  return (
    <section className="flex flex-col pt-5 gap-[3rem]">
      <h3 className="text-heading2">
        {kind === 'REGISTER'
          ? REGISTER_CAUTION.HEADING
          : PRE_REGISTER_CAUTION.HEADING}
      </h3>
      <div className="space-y-5">
        {kind === 'REGISTER' ? (
          ...
          <div className="space-y-5">
            {Object.entries(PRE_REGISTER_CAUTION.CONTENT).map(
              ([key, value]) => (
